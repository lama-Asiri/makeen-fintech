import svgPaths from "./svg-4tmpm23p4a";
import imgSidePic from "@/assets/947a2afba4a6a78c9261396d816fb9015697ffc4.png";

function SideFrameJustToKnowWhereToPutSidePic() {
  return (
    <div className="absolute bg-[#382f5e] h-[1024px] left-[-5.5px] overflow-clip top-[-1.45px] w-[810px]" data-name="side frame just to know where to put side pic">
      <div className="absolute h-[1696px] left-[-128.5px] top-[-398.55px] w-[950px]" data-name="side pic">
...
function Frame2() {
  return (
    <div className="absolute bg-[#fffcfe] inset-[39.13%_0_0_0] rounded-[8px]">
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <p className="col-1 font-['Roboto:Regular',sans-serif] font-normal h-[15px] leading-[24px] ml-[27.29px] mt-0 relative row-1 text-[#fffcfe] text-[16px] w-[165.707px] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Remember Me
      </p>
      <CheckIcon />
    </div>
...
function LargeButton() {
  return (
    <div className="bg-[#7760bd] content-stretch flex h-[56px] items-center justify-center overflow-clip px-[24px] py-[16px] relative rounded-[8px] shrink-0 w-[344px]" data-name="Large Button">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[16px] text-black text-center">Login</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex font-['Roboto:Regular',sans-serif] font-normal gap-[2px] items-center relative shrink-0 text-[16px] text-center w-[229px] whitespace-pre-wrap">
      <p className="h-[23px] leading-[0] relative shrink-0 text-[0px] text-black w-[167px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <span className="leading-[24px] text-[#fffcfe]" style={{ fontVariationSettings: "'wdth' 100" }}>
          Don’t have an account?
        </span>
        <span className="leading-[24px]">{`  `}</span>
      </p>
      <p className="h-[23px] leading-[24px] relative shrink-0 text-[#da876b] w-[58px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Sign Up
      </p>
    </div>
  );
...
function Login() {
  return (
    <div className="-translate-y-1/2 absolute h-[616.232px] left-[936px] top-[calc(50%+0.12px)] w-[384px]" data-name="Login">
      <LoginFormGroup />
